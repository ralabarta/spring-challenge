...
class AppUserResourceIT {
    ...
    private static final LocalDate DEFAULT_LAST_LOGINDATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_LAST_LOGINDATE = LocalDate.now(ZoneId.systemDefault());
    ...
    public static AppUser createEntity(EntityManager em) {
        AppUser appUser = new AppUser()
            ...
            .lastLogindate(DEFAULT_LAST_LOGINDATE);
        // Add required entity
        AppRole appRole;
    ...
    public static AppUser createUpdatedEntity(EntityManager em) {
        AppUser appUser = new AppUser()
            ...
            .lastLogindate(UPDATED_LAST_LOGINDATE);
        // Add required entity
        AppRole appRole;
        if (TestUtil.findAll(em, AppRole.class).isEmpty()) {
            appRole = AppRoleResourceIT.createUpdatedEntity(em);
            em.persist(appRole);
            em.flush();
        } else {
            appRole = TestUtil.findAll(em, AppRole.class).get(0);
    ...
    void createAppUser() throws Exception {
        ...
        assertThat(testAppUser.getLastLogindate()).isEqualTo(DEFAULT_LAST_LOGINDATE);
    }
    ...
    void getAllAppUsers() throws Exception {
        ...
        restAppUserMockMvc
            ...
            .andExpect(jsonPath("$.[*].lastLogindate").value(hasItem(DEFAULT_LAST_LOGINDATE.toString())));
    }
    ...
    void getAppUser() throws Exception {
        ...
        restAppUserMockMvc
            ...
            .andExpect(jsonPath("$.lastLogindate").value(DEFAULT_LAST_LOGINDATE.toString()));
    }
    ...
    void putNewAppUser() throws Exception {
        ...
        assertThat(testAppUser.getLastLogindate()).isEqualTo(UPDATED_LAST_LOGINDATE);
    }
    ...
    void partialUpdateAppUserWithPatch() throws Exception {
        ...
        partialUpdatedAppUser.username(UPDATED_USERNAME).password(UPDATED_PASSWORD).email(UPDATED_EMAIL).phoneNumber(UPDATED_PHONE_NUMBER);
