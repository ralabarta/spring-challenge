...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './app-role.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPROLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPROLE actions', async () => {
      const expectedActions = [
        {
